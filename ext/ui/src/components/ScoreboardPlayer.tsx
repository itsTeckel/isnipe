        ...
        <>
            {player.name &&
                <div className={"playerHolder " + curPlayer + (player.isDead ? 'isDead ' : 'isAlive ') + 'pos'+place}>
                    <div className="playerAvatar"><img width="32px" src={"https://community.veniceunleashed.net/user_avatar/community.veniceunleashed.net/"+player.name+"/64/559_2.png"}/> </div>
